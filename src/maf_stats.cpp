...
void stats(Parameters& parameters) {
    ...
    if (parameters.alignability_table_file_path != "") output_alignability_table(parameters, metrics);
//    if (parameters.alignability_wig_file_path != "") output_alignability_wig(parameters, metrics);
//    if (parameters.identity_wig_file_path != "") output_identity_wig(parameters, metrics);
//    if (parameters.major_allele_wig_file_path != "") output_major_allele_wig(parameters, metrics);
//    if (parameters.allele_count_wig_file_path != "") output_allele_count_wig(parameters, metrics);
}
